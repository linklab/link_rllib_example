...
from tutorials.codes.multi_agents.agents.a_dummy_agent import Dummy_Agent
...
class TicTacToe343(gym.Env):
    def __init__(self, env_config: EnvContext):
        ...
        self.observation_space = Box(low=-1.0, high=1.0, shape=(self.BOARD_SIZE,))
        self.INITIAL_STATE = State(board_rows=self.env_config["board_rows"], board_cols=self.env_config["board_cols"])  # 초기 상태 설정
